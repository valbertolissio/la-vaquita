...
export function PantallaEditarPerfil({ navigation }: any) {
  ...
  const previewColor = colorDeAvatar(user!.id, color);
      ...
      <View style={styles.content}>
        <View style={styles.previewWrap}>
          <View style={[styles.previewCircle, { backgroundColor: previewColor }]}>
            <Text style={styles.previewText}>{iniciales(previewName)}</Text>
          </View>
        </View>
        ...
        <View style={styles.swatchRow}>
          {AVATAR_COLOR_KEYS.map((key) => {
            const hex = colorDeAvatar(user!.id, key);
