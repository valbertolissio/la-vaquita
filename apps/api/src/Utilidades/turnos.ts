...
export function siguienteTurno(memberOrder: string[], cursor: number): number {
 ...
 */
export function calcularDuracionEnSegundos(startDate: Date | null, completedAt: Date): number | null {
