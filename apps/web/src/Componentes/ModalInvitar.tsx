...
export function ModalInvitar({ tripId, tripName, onClose }: Props) {
  ...
  async function sendByEmail() {
    ...
    try {
      const invitation = await api.invitarParticipante(tripId, email);
