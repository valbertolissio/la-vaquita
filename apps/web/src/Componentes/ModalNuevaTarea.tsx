...
export function ModalNuevaTarea({ tripId, trip, task, onClose, onCreated }: Props) {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (isEditing) {
        await api.actualizarTarea(tripId, task!.id, { ...payload, assignedToId: assignmentType === "MANUAL" ? assignedToId : undefined });
      } else {
        await api.crearTarea(tripId, {
          ...payload,
          assignmentType,
